...
Database.initResearch = function() {
    ...
    this.research = topics.map((topic, i) => {
        const status = ['Đang thực hiện', 'Hoàn thành', 'Đã xuất bản'][Math.floor(Math.random() * 3)];
        // Tự động set progress = 100 nếu đã hoàn thành hoặc xuất bản
        const progress = (status === 'Hoàn thành' || status === 'Đã xuất bản') ? 100 : Math.floor(Math.random() * 100);
    ...
    this.notifications = [
        {
            ...
            message: 'Lịch thi học kỳ I năm học 2024-2025 đã được công bố. Sinh viên vui lòng kiểm tra lịch thi và chuẩn bị ôn tập.',
            type: 'academic',
            priority: 'high',
        ...
        },
        {
            ...
            message: 'Hệ thống sẽ bảo trì vào 2h sáng ngày 10/12/2024. Trong thời gian này, một số tính năng có thể không khả dụng.',
            type: 'system',
            priority: 'medium',
        ...
        },
        {
            ...
            message: 'Học phí học kỳ II đã đến hạn thanh toán. Vui lòng thanh toán trước ngày 15/12/2024 để tránh bị khóa tài khoản.',
            type: 'finance',
            priority: 'high',
        ...
        {
            id: 'NOT005',
            title: 'Kết quả học tập học kỳ I',
            message: 'Kết quả học tập học kỳ I đã được công bố. Sinh viên có thể xem điểm trên hệ thống.',
            type: 'academic',
            priority: 'high',
        ...
        {
            id: 'NOT006',
            title: 'Đăng ký môn học kỳ II',
            message: 'Thời gian đăng ký môn học kỳ II từ 01/12/2024 đến 15/12/2024. Sinh viên vui lòng đăng ký đúng hạn.',
            type: 'academic',
            priority: 'medium',
        ...
        },
        {
            ...
            message: 'Hội thảo khoa học cấp trường sẽ được tổ chức vào ngày 20/12/2024. Mời các giảng viên và sinh viên tham gia.',
            type: 'event',
            priority: 'medium',
        ...
        {
            id: 'NOT008',
            title: 'Cảnh báo sinh viên có nguy cơ',
            message: 'Hệ thống AI phát hiện 15 sinh viên có nguy cơ bỏ học. Giảng viên chủ nhiệm vui lòng liên hệ và hỗ trợ.',
            type: 'alert',
            priority: 'high',
...
Database.updateResearch = function(id, data) {
    ...
    if (index !== -1) {
        // Tự động set tiến độ = 100% nếu đã hoàn thành hoặc xuất bản
        if (data.status === 'Hoàn thành' || data.status === 'Đã xuất bản') {
            data.progress = 100;
        }
